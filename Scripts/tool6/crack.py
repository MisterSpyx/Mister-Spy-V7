import socket,threading,base64,datetime,sys,ssl,imaplib,time,re,Queue
#!/usr/bin/python
 # -*-coding:Latin-1 -*
import sys,urllib2
...
def print_logo():
  ...
  ____            _          ____                _             
 / ___| _ __ ___ | |_ _ __  / ___|_ __ __ _  ___| | _____ _ __ 
...
cls()
print_logo()
Emailk=raw_input('[+] Enter Your Email : ')
to_check={}
...
try:
	...
	exit()
zz = raw_input('enter Combo List Name :')
